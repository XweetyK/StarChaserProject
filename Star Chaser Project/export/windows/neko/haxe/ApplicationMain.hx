...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Leo Perugini", "StarChaserProject", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Star Chaser Project";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Star Chaser Project", null, { width: 1200, height: 620 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1200, height: 620 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 1200, 620, "null");
		#end
		#else
		create ();
		#end
